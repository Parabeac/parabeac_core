...
class OverrideHelper {
  ...
  static final SN_UUIDtoVarName = <String, List<PBSharedParameterProp>>{};

  /// Adds `property` to `SN_UUIDtoVarName` map based on `property`'s [UUID]
  static void addProperty(PBSharedParameterProp property) {
  ...
  /// Returns a `PBSharedParameterProp` matching given `uuid` and `type` of override.
  ///
  /// Returns [null] if no match is found
  static PBSharedParameterProp getProperty(String uuid, String type) {
